...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-15 16:05`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a1f763a5-063e-4c6b-927c-357e4d9a67b2.git
$ cd a1f763a5-063e-4c6b-927c-357e4d9a67b2
```
